...
<link rel="stylesheet" type="text/css" href="CSS/borrow.css">
  ...
  <jsp:include page="navigation.jsp"></jsp:include>
    <div class="cendiv">
    	<div class="font_style1"><span>当前位置：图书借还 > 图书归还  >>></span></div>
    	<div class="bookret">
    		<img src="images/borrowBackRenew_back.gif">
    		<div class="nr">
	    		<div class="yanz">
	    			...
	    			<table id="jieyue">
    					<tr style="background-color: gray; text-align: center;"><td>图书名称</td><td>借阅时间</td><td>应还时间</td><td>出版社</td><td>书架</td><td>定价(元)</td><td><input type="button" value="完成归还"/></td></tr>
    					<tr><td>Java学习指南</td><td> 2007-11-26</td><td>2007-12-26</td><td>清华大学出版社</td><td>A架</td><td> 89.0</td><td><a href="#">归还</a></td></tr>
    					<tr><td>Java学习指南</td><td> 2007-11-26</td><td>2007-12-26</td><td>清华大学出版社</td><td>A架</td><td> 89.0</td><td><a href="#">归还</a></td></tr>
